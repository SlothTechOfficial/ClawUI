      ...
      <div class="pricings-list">
        ...
        <div class="table-price table-price--recomend">
          <div class="table-price__head">
            ...
            <p class="table-price__price"><span class="currency"> <span class="currency"> $</span></span>1,299</p>
          </div>
          <div class="table-price__body">
            <ul class="table-price__list">
              <li class="table-price__items">
        ...
        <div class="table-price">
          <div class="table-price__head">
            ...
            <p class="table-price__price"><span class="currency"> $</span>899</p>
          </div>
          <div class="table-price__body">
            <ul class="table-price__list">
              <li class="table-price__items">
